...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container mt-3">
        ...
        <div class="col-md-12 text-center" id="pregunta">
            <h3>Disponeis de política de contraseñas en las cuentas tanto locales como en nube?</h3>
        </div>
        <div class="row pt-5">
            <div class="col-md-4">
                <button class="btn btn-lg w-100" type="button">Sí</button>
            </div>
            <div class="col-md-4">
        ...
        <div id="controles-cuestionario" class="row">
            <div class="col-md-4">
                <button class="btn btn-lg w-100" type="button">Atrás</button>
            </div>
            <div class="col-md-4">
