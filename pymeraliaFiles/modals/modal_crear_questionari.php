            ...
            <div class="modal-body">
              <form id="test" action="../actions/crear_questionari.php" method="POST">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="name_questionary" id="name_questionary_crear">
                </div>
                <div class="mb-3">
                  <label for="message-text" class="col-form-label">Autor:</label>
                  <input type="text" class="form-control" name="autor_questionary" id="autor_questionary_crear">
                </div>
                <div class="mb-3">
                  <label for="message-text" class="col-form-label">Fecha:</label>
                  <input type="date" class="form-control" name="date_questionary" id="date_questionary_crear">
                </div>
